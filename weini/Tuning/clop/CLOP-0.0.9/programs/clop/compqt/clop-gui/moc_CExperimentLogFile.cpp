...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CExperimentLogFile_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CExperimentLogFile_t qt_meta_stringdata_CExperimentLogFile = {
    {
QT_MOC_LITERAL(0, 0, 18), // "CExperimentLogFile"
QT_MOC_LITERAL(1, 19, 9), // "OnMessage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 11), // "std::string"
QT_MOC_LITERAL(4, 42, 8) // "sMessage"
...
const QMetaObject CExperimentLogFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CExperimentLogFile.data,
      qt_meta_data_CExperimentLogFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CExperimentLogFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CExperimentLogFile.stringdata0))
