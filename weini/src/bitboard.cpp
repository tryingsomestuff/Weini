...
const BitBoard BitBoards::whiteKingQueenSide = 0x0000000000000007;
const BitBoard BitBoards::whiteKingKingSide  = 0x00000000000000E0;
const BitBoard BitBoards::blackKingQueenSide = 0x0700000000000000;
const BitBoard BitBoards::blackKingKingSide  = 0xe000000000000000;
...
const Piece::eType BitBoards::Get (Square::LightSquare k) const{
   const BitBoard b = SquareToBitboard(k);
