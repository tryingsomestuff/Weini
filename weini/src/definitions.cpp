...
Definitions::Selectivity::Selectivity(){
    ...
    nullMoveMargin          = 10;
    futilityMargin          = 300;
    futilityDepthCoeff      = 0;
    qfutilityMargin         = 128;
    deltaMargin             = 1300;
    /*
    razoringMargin          = 100;
    razoringDepthCoeff      = 50;
    */
    staticNullMoveMargin    = 20;
    staticNullMoveDepthCoeff= 100;
    lmrtol                  = 100;
    LMR_STD                 = 3;
    LMR_ENDGAME             = 9; // less is not enough
...
// Extension config
//*****************************
Definitions::ExtensionConfig Definitions::extensionConfig;

Definitions::ExtensionConfig::ExtensionConfig(){
...
Definitions::SortingConfig::SortingConfig(){
    ...
    do_sortenpassantbonus    = true; // this is often the good thing to do ;-)
    do_sortchessbonus        = false;
...
Definitions::Algorithms::Algorithms(){
    ...
    do_quiesce            = true;
    do_futilityPruning    = false;
    do_qfutilityPruning   = false;
    do_razoring           = true;
    do_staticNullMove     = true;
    do_seePruning         = false;
    do_seePruningAlphaBeta= false;
...
void Definitions::InitKeys() {
    ...
    */
    ...
    // Extension config
    //*****************************
    _keys.push_back(KeyBase(k_bool, "do_checkExtensionRoot"              , &extensionConfig.do_CheckExtensionRoot));
    _keys.push_back(KeyBase(k_bool, "do_checkExtensionSearch"            , &extensionConfig.do_CheckExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_checkExtensionAlphaBeta"         , &extensionConfig.do_CheckExtensionAlphaBeta));
    _keys.push_back(KeyBase(k_bool, "do_NearPromotionExtensionAlphaBeta" , &extensionConfig.do_NearPromotionExtensionAlphaBeta));
    _keys.push_back(KeyBase(k_bool, "do_EndGameExtensionSearch"          , &extensionConfig.do_EndGameExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_VeryEndGameExtensionSearch"      , &extensionConfig.do_VeryEndGameExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_PVExtensionSearch"               , &extensionConfig.do_PVExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_SingleReplyExtensionSearch"      , &extensionConfig.do_SingleReplyExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_SingleReplyExtensionAlphaBeta"   , &extensionConfig.do_SingleReplyExtensionAlphaBeta));
    _keys.push_back(KeyBase(k_bool, "do_SingularExtensionAlphaBeta"      , &extensionConfig.do_SingularExtensionAlphaBeta));
    _keys.push_back(KeyBase(k_bool, "do_NearPromotionExtensionSearch"    , &extensionConfig.do_NearPromotionExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_ReCaptureExtensionSearch"        , &extensionConfig.do_ReCaptureExtensionSearch));
    _keys.push_back(KeyBase(k_bool, "do_ReCaptureExtensionAlphaBeta"     , &extensionConfig.do_ReCaptureExtensionAlphaBeta));
    ...
    _keys.push_back(KeyBase(k_bool, "do_sortchessbonus"                  , &sortingConfig.do_sortchessbonus));
    ...
    _keys.push_back(KeyBase(k_bool, "do_mountCountPruning"               , &algo.do_mountCountPruning));
...
bool Definitions::SetValue(const std::string & key, const std::string & value){
    bool keyFound = false;
    KeyBase & keyRef = _keys[0]; // assume _key is not empty ...
