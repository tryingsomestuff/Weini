...
Stats::AtomicCounter Stats::alphacut                ;
Stats::AtomicCounter Stats::betacut                 ;
Stats::AtomicCounter Stats::betacutroot             ;
Stats::AtomicCounter Stats::qalphacut               ;
Stats::AtomicCounter Stats::qbetacut                ;
Stats::AtomicCounter Stats::qearlyalphacut          ;
Stats::AtomicCounter Stats::qearlybetacut           ;
Stats::AtomicCounter Stats::qearlyalphadeltacut     ;
Stats::AtomicCounter Stats::qearlybetadeltacut      ;
Stats::AtomicCounter Stats::deltaalphacut           ;
Stats::AtomicCounter Stats::deltabetacut            ;
...
Stats::AtomicCounter Stats::nullmoveReset           ;
/*
...
Stats::AtomicCounter Stats::minseldepth[MAX_SEARCH_DEPTH]       ;
Stats::AtomicCounter Stats::maxseldepth[MAX_SEARCH_DEPTH]       ;
Stats::AtomicCounter Stats::meanseldepth[MAX_SEARCH_DEPTH]      ;
Stats::AtomicCounter Stats::meanseldepthcount[MAX_SEARCH_DEPTH] ;
...
void Stats::Init(){
    ...
    */
    ...
    for (DepthType k = 0 ; k < MAX_SEARCH_DEPTH ; ++ k){
      ...
      Stats::minseldepth[k]        = 100;
      Stats::maxseldepth[k]        = 0;
      Stats::meanseldepth[k]       = 0;
      Stats::meanseldepthcount[k]  = 0;
    }
...
void Stats::CutCount(){
  ...
  LOG(logINFO) << "alphacut                             " << Stats::alphacut              ;
  LOG(logINFO) << "betacut                              " << Stats::betacut               ;
  LOG(logINFO) << "betacutroot                          " << Stats::betacutroot           ;
  LOG(logINFO) << "qalphacut                            " << Stats::qalphacut             ;
  LOG(logINFO) << "qbetacut                             " << Stats::qbetacut              ;
  LOG(logINFO) << "qearlyalphacut                       " << Stats::qearlyalphacut        ;
  LOG(logINFO) << "qearlybetacut                        " << Stats::qearlybetacut         ;
  LOG(logINFO) << "qearlyalphadeltacut                  " << Stats::qearlyalphadeltacut   ;
  LOG(logINFO) << "qearlybetadeltacut                   " << Stats::qearlybetadeltacut    ;
  LOG(logINFO) << "deltaalphacut                        " << Stats::deltaalphacut         ;
  LOG(logINFO) << "deltabetacut                         " << Stats::deltabetacut          ;
  ...
  LOG(logINFO) << "nullmoveReset                        " << Stats::nullmoveReset         ;
  /*
  ...
  */
  ...
  for(DepthType k = 0 ; k < MAX_SEARCH_DEPTH ; ++k){
     if ( Stats::meanseldepthcount[k] > 0){
        LOG(logINFO) << std::setw(3) << (int)k << " minseldepth  " << Stats::minseldepth[k];
        LOG(logINFO) << std::setw(3) << (int)k << " maxseldepth  " << Stats::maxseldepth[k];
        LOG(logINFO) << std::setw(3) << (int)k << " meanseldepth " << Stats::meanseldepth[k]/Stats::meanseldepthcount[k];
     }
  }
