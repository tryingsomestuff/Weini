...
engine = 'name=Weini cmd=/media/BK1/www/p/chessEngine/weini/bin/weini arg=-x dir=/media/BK1/www/p/chessEngine/weini/bin/'
...
options = '-each proto=xboard tc=80/1 -draw movenumber=80 movecount=5 score=5 -resign movecount=5 score=500 -openings file=/media/BK1/www/p/chessEngine/weini/BookPgn/AH-150.pgn format=pgn order=random plies=12'
