...
SearcherBase::SearchedMove ThreadPool<T>::SearchSync(const SearcherBase::Data & d) {
    ...
    LOG(logINFO) << "SearchSync begin";
    LOG(logINFO) << "SearchSync waiting for threads";
    ...
    LOG(logINFO) << "SearchSync all threads ok";
...
void ThreadPool<T>::SearchASync(const SearcherBase::Data & d) {
    ...
    LOG(logINFO) << "SearchASync begin";
    LOG(logINFO) << "SearchASync waiting for threads";
    ...
    LOG(logINFO) << "SearchASync all threads ok";
