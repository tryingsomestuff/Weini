...
class Stats{
   ...
   static AtomicCounter reductionAndPruningReset;
   static AtomicCounter extensionReset         ;
   ...
   static AtomicCounter currentLeafNodesCount  ;
   ...
   static AtomicCounter seldepth[MAX_SEARCH_DEPTH];
