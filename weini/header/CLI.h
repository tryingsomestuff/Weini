...
SearcherBase::SearchedMove TestAnalysis(Position & pAnal, DepthType depth, bool display = true);

SearcherBase::SearchedMove TestAnalysis(const std::string & fen, DepthType depth, bool display = true);
