...
#ifdef WITH_STATS
#define OPTIM_STATS(x) x
#else
#define OPTIM_STATS(x)
#endif

#ifdef WITH_BOOL_OPTIM
#define OPTIM_BOOL_TRUE(b) true
#define OPTIM_BOOL_FALSE(b) false
#else
#define OPTIM_BOOL_TRUE(b) (b)
#define OPTIM_BOOL_FALSE(b) (b)
#endif
...
typedef unsigned short int PlyType;
...
public:
  ...
  struct ExtensionReductionConfig {
      ...
      bool do_recursiveExtension;
      bool do_recursiveReduction;
  };
...
private:
  ...
  public:
      static KeyBase & GetKey(const std::string & key) {
          bool keyFound = false;
