...
public:
  ...
  struct Selectivity {
    ...
    */
    ...
    DepthType iterativeDeepeningSelectivityMinDepth; //3
    DepthType staticNullMoveMaxDepth; //2
    DepthType futilityMaxDepth; //3
    DepthType nullMovePruningMinDepth; //2
    DepthType verifiedNullMoveMinDepth; //6
    DepthType moveCountPruningMaxDepth; //10
    DepthType recursiveNullMoveMinDepth; //5
    DepthType seePruningAlphaBetaMaxDepth; // 6
    DepthType lmrMinDepth; //2
  ...
  static ExtensionConfig extensionConfig;
